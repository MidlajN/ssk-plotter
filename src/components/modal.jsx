                ...
                { socket.connected ?
                    <div className="flex items-center gap-6 p-5">
                        ...
                        <div className="config">
                            { socket.connecting ? 
                                ...
                                <p className="text-[25px] text-[#831414]">
                                    Couldn't Connect
                                </p>
                            }
                    ...
                    <div className="p-5">
                        <div className="flex items-center gap-6">
                            ...
                            <div className="config">
                                    <p className="text-[22px] text-[#14831a]">
                        ...
                        <div className="flex justify-between items-start pt-12">
                            <div>
                                <p className="text-nowrap text-[27px] font-semibold text-gray-500 flex items-baseline gap-2">
                                    <span>Ready To</span> 
                                    <span className="text-[#092f61]">Plot</span> 
                                    <span className="text-[30px] font-extrabold text-[#092f61]">!</span>
                                </p>
                                <p className="text-[13px] pr-3">Click the <span className="font-semibold">'Plot'</span> Button to draw the pictures in from the canvas.</p>
                            </div>
                            <img className="object-contain w-[45%]" src="/plot.svg" alt="" />
                        </div>
                    </div>
                }
                </div>
